...
import { 
  Download, Film, Music, Loader2, AlertCircle, Link as LinkIcon, 
  Settings2, Subtitles, ChevronDown, Info, Check, X, Trash2, 
  History, Ghost, EyeOff, Eye, FolderOpen, ExternalLink, 
  FileText, Play, Pause 
} from 'lucide-react';
                  ...
                  {format === 'video' && (
                    <div className="space-y-3 pt-2">
                      ...
                      <div className="flex items-start gap-2 px-1">
                        ...
                        <p className="text-[10px] leading-tight text-amber-500/50 italic font-medium">
                          {t.subtitlesWarning || "Note: Subtitle detection is requested from mirror servers."}
                        </p>
                      </div>

                      {downloadSubtitles && (
                        <div className="space-y-4 pl-6 pt-2 border-l-2 border-[rgb(var(--foreground))]/10">
                          <motion.div 
                          ...
                          >
                            <div className="flex flex-col">
                              <span className="text-xs font-semibold text-[rgb(var(--foreground))]/80 uppercase tracking-widest">
                                {t.embedSubtitlesLabel}
                              </span>
                              <span className="text-[9px] text-[rgb(var(--foreground))]/40 italic">Hard-code into video file</span>
                            </div>
                            <button
                              type="button"
                              disabled={isLoading}
                              ...
                              className={cn(
                                "w-8 h-4 rounded-full transition-all flex items-center p-0.5 shadow-inner",
                                embedSubtitles ? "bg-[rgb(var(--foreground))] justify-end shadow-[rgb(var(--foreground))]/20" : "bg-[rgb(var(--foreground))]/20 justify-start"
                              )}
                            >
